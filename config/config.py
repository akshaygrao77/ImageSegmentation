...
def get_transform(is_train,dataset=None):
    ...
    if is_train:
        ...
        transforms_image = Compose([
            RandomResizedCrop(size=final_size, scale=(0.7, 2.0), ratio=(0.72,1.5), interpolation=InterpolationMode.BILINEAR),
        ...
        transforms_mask = transforms.Compose([
            RandomResizedCrop(size=final_size, scale=(0.7, 2.0), ratio=(0.72,1.5), interpolation=InterpolationMode.NEAREST),
